...
test('DHTStore: launch DHTStore', function (t) {
  var dht = new DHTStore(dir, {
    bootstrap: false
  })

  common.failOnWarningOrError(t, dht)

  dht.listen (2000, function () {
    t.end()
  });
})

test('DHTStore: `ping` query send from DHTStore and response from DHT', function (t) {
  t.plan(2)
  var dht1 = new DHTStore(dir, { bootstrap: false })
...
test('DHTStore: `find_node` query for exact match (with one in table)', function (t) {
  t.plan(3)
...
test('DHTStore: `find_node` query (with many in table)', function (t) {
  t.plan(3)
  var dht1 = new DHTStore(dir, { bootstrap: false })
  var dht2 = new DHT({ bootstrap: false })
...
test('DHTStore: `get_peers` query to node with *no* peers in table', function (t) {
  t.plan(4)
  var dht1 = new DHTStore(dir, { bootstrap: false })
  var dht2 = new DHT({ bootstrap: false })
...
test('DHTStore: `get_peers` query to node with peers in table', function (t) {
  t.plan(4)
...
test('DHTStore: `announce_peer` query with bad token', function (t) {
  t.plan(2)
  var dht1 = new DHTStore(dir, { bootstrap: false })
  var dht2 = new DHT({ bootstrap: false })
...
test('DHTStore: `announce_peer` query gets ack response', function (t) {
  t.plan(5)
